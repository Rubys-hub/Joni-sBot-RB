export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    try {
      ...
      if (isNaN(price) || price < 2000) return m.reply(`⌬ El precio mínimo para subastar un personaje es de *S/2,000 ${currency}*.`)
      if (price > 100_000_000) return m.reply(`⌬ El precio máximo permitido para subastar un personaje es de *S/100,000,000 ${currency}*.`)
