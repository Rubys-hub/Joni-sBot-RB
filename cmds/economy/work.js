export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    if (Date.now() < user.lastwork) {
      ...
      return client.reply(m.chat, `⏳ ᴇsᴘᴇʀᴀ ✦ Debes esperar *${tiempoRestante}* para usar *${usedPrefix + command}* otra vez.`, m)
    }
    ...
    await client.sendMessage(m.chat, { text: `💼 ᴡᴏʀᴋ ✦ ${pickRandom(trabajo)} ✦ Ganaste *S/${rsl.toLocaleString()} ${monedas}*.` }, { quoted: m })
  }
}
