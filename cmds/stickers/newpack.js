export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    try {
      ...
      const newPack = { id: Date.now().toString(), lastModified: Date.now().toString(), name, author: '✧𖤐༒ ʀᴜʙʏᴊx 🌀 ʙᴏᴛ ༒𖤐✧', desc: `Paquete de stickers creado por ${dev}`, stickers: [], spackpublic: 0 }
      packs.push(newPack)
